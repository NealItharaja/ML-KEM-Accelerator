...
module test_compress;
    ...
    initial begin
        ...
        x = 12'd0;    
        #1; 
        check(y10, cref(0, 10), "D10 x=0");

        x = 12'd1;    
        #1; 
        check(y10, cref(1, 10), "D10 x=1");

        x = 12'd1664; 
        #1; 
        check(y10, cref(1664, 10), "D10 x=1664");

        x = 12'd1665; 
        #1; 
        check(y10, cref(1665, 10), "D10 x=1665");

        x = 12'd3328; 
        #1; 
        check(y10, cref(3328, 10), "D10 x=3328");
        ...
        x = 12'd0;    
        #1; 
        check(y4, cref(0, 4), "D4 x=0");

        x = 12'd3328; 
        #1; 
        check(y4, cref(3328, 4), "D4 x=3328");

        x = 12'd0;    
        #1; 
        check(y1, cref(0, 1), "D1 x=0");

        x = 12'd1665; 
        #1; 
        check(y1, cref(1665, 1), "D1 x=1665");

        x = 12'd3328; 
        #1; 
        check(y1, cref(3328, 1), "D1 x=3328");
