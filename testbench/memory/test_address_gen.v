...
module address_gen_tb;
    ...
    begin
        ...
        if (rd_addr_b === rd_addr_a + (8'd1 << DUT.stage)) begin
            ...
            $display("FAIL [stage %0d]: distance Got=%0d Expected=%0d (a=%0d b=%0d)", DUT.stage, rd_addr_b - rd_addr_a, (8'd1 << DUT.stage), rd_addr_a, rd_addr_b);
    ...
    initial begin
        ...
        if (rd_count == 1024)
            ...
            $display("FAIL: read count %0d != 1024", rd_count);
            fail_count = fail_count + 1;
        end
        ...
        if (wr_count == 1024)
            ...
            $display("FAIL: write count %0d != 1024", wr_count);
            fail_count = fail_count + 1;
        end
